                                                         ...
                                                         <table id="zero-configuration" class="display table nowrap table-striped table-hover dataTable" style="width: 100%;" role="grid" aria-describedby="zero-configuration_info">
                                                            <thead>
                                                               <tr role="row">
                                                                  ...
                                                                  <th class="sorting" tabindex="0" rowspan="1" colspan="1">Kit</th>
                                                            ...
                                                            <?php foreach ($obj_customer as $value): ?>
                                                              <tr>
                                                                ...
                                                                <td>
                                                                  <h6><?php echo $value->kit;?></h6>
                                                                </td>
                                                                <td>
                                                                  <h6><?php echo $value->usdt;?></h6>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <div class="operation">
                                                                            <div class="btn-group">
                                                                              <button type="button" class="btn btn-icon btn-info" onclick="edit_customer('<?php echo $value->customer_id;?>');"><i class="fa fa-edit"></i></button>
                                                                            </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
