                                                         ...
                                                         <table id="zero-configuration" class="display table nowrap table-striped table-hover dataTable" style="width: 100%;" role="grid" aria-describedby="zero-configuration_info">
                                                            <thead>
                                                               <tr role="row">
                                                                  ...
                                                                  <th class="sorting" rowspan="1" colspan="1">Puntos Personales</th>
                                                                  <th class="sorting" rowspan="1" colspan="1">Puntos Grupales</th>
                                                            ...
                                                            <tbody>
                                                               ...
                                                               <tr>
                                                                  ...
                                                                  <td><img width="90" src="<?php echo site_url("img/rangos/".$value->img);?>" alt="<?php echo $value->name;?>"/></td>
                                                                  <td>
