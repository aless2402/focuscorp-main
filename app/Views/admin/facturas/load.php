                              ...
                              <div class="card">
                                 ...
                                 <form name="form-invoices" enctype="multipart/form-data" method="post" action="javascript:void(0);" onsubmit="validate();">
                                       ...
                                       <div class="form-group col-md-12">
                                          ...
                                          if(isset($obj_invoices)){ ?>
                                             <div class="form-group">
                                                   <label>ID</label>
                                                   <input class="form-control" type="text" id="invoice_id" name="invoice_id" value="<?php echo isset($obj_invoices[0]->invoice_id)?$obj_invoices[0]->invoice_id:"";?>" class="input-xlarge-fluid" placeholder="ID" disabled="">
                                                   <input type="hidden" id="invoice_id" name="invoice_id" value="<?php echo isset($obj_invoices[0]->invoice_id)?$obj_invoices[0]->invoice_id:"";?>">
                                             </div>
                                       <?php } ?>
                                       </div>
                                    <div class="form-group col-md-6">
                                          ...
                                          <div class="form-group">
                                             <label>Cliente</label>
                                             <input class="form-control" type="text" id="customer" name="customer" value="<?php echo isset($obj_invoices[0]->first_name)?$obj_invoices[0]->first_name." ".$obj_invoices[0]->last_name:"";?>" class="input-xlarge-fluid" placeholder="Cliente" disabled="">
                                          </div>
                                          <div class="form-group">
                                             <label>Fecha</label>
                                    ...
                                    <div class="form-group col-md-6">
                                                ...
                                                <option value="<?php echo $value->kit_id;?>"
                                                      <?php 
                                                            if(isset($obj_invoices[0]->kit_id)){
                                                                     if($obj_invoices[0]->kit_id==$value->kit_id){
                                                                        echo "selected";
                                                                     }
                                                            }else{
                                                                        echo "";
                                          ...
                                          <label for="inputState">Tipo</label>
                                                ...
                                                <option value="1" <?php if(isset($obj_invoices)){
                                                      if($obj_invoices[0]->type == 1){ echo "selected";}
                                                }else{echo "";} ?>>CryptoPool</option>
                                                <option value="2" <?php if(isset($obj_invoices)){
                                                      if($obj_invoices[0]->type == 2){ echo "selected";}
                                                }else{echo "";} ?>>Fondo Inmobiliario</option>
                                                </select>
                                          </div>
                                          <div class="form-group">
                                                <label for="inputState">Financiado</label>
                                                   <select name="financy" id="financy" class="form-control">
                                                      <option value="">[ Seleccionar ]</option>
                                                      <option value="1" <?php if(isset($obj_invoices)){
                                                            if($obj_invoices[0]->financy == 1){ echo "selected";}
                                                      }else{echo "";} ?>>Si</option>
                                                      <option value="0" <?php if(isset($obj_invoices)){
                                                            if($obj_invoices[0]->financy == 0){ echo "selected";}
                                                      }else{echo "";} ?>>No</option>
                                                   </select>
                                          </div>
                                          <div class="form-group">
