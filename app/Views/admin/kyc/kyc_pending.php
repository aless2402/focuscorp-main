...
<html lang="es-PE">
   ...
   <body data-new-gr-c-s-check-loaded="14.1042.0" data-gr-ext-installed="">
                                                            ...
                                                            <?php foreach ($obj_customer as $value): ?>
                                                               <tr>
                                                                  ...
                                                                  <td>
                                                                        <div class="operation">
                                                                           <div class="btn-group">
                                                                              <button class="btn btn-success buttons-copy buttons-html5" onclick="verificado('<?php echo $value->customer_id;?>');"  type="button"><span><i class="fa fa-check" aria-hidden="true"></i></span></button>
                                                                              <button class="btn btn-danger buttons-copy buttons-html5" onclick="rechazado('<?php echo $value->customer_id;?>');" type="button"><span><i class="fa fa-ban" aria-hidden="true"></i></span></button>
                                                                           </div>
                                                                        </div>
                                                                  </td>
                                                               </tr>
      ...
      <script src="<?php echo base_url('js/backoffice/admin/kyc.js'); ?>"></script> 
      <!-- [ Header ] end -->
      <!-- [ Main Content ] end -->
