                                       ...
                                       <div class="form-group col-md-6">
                                          ...
                                          <div class="form-group">
                                             <label for="inputState">Estado</label>
                                                   ...
                                                   <option value="1" <?php if(isset($obj_comissions)){
                                                         if($obj_comissions[0]->active == 1){ echo "selected";}
                                                   }else{echo "";} ?>>Activo</option>
                                                   <option value="0" <?php if(isset($obj_comissions)){
                                                         if($obj_comissions[0]->active == 0){ echo "selected";}
