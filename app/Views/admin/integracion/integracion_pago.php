...
<html lang="es-PE">
   ...
   <body data-new-gr-c-s-check-loaded="14.1042.0" data-gr-ext-installed="">
                                                ...
                                                <div id="zero-configuration_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                                   <div class="row">
                                                      ...
                                                      <table id="zero-configuration" class="display table nowrap table-striped table-hover dataTable" style="width: 100%;" role="grid" aria-describedby="zero-configuration_info">
                                                            ...
                                                            <div class="operation">
                                                               <div class="btn-group">
                                                                  <button type="button" class="btn btn-icon btn-info" onclick="edit_integrate('<?php echo $value->commissions_id;?>');"><i class="fa fa-edit"></i></button>
                                                                  <button type="button" class="btn btn-icon btn-danger" onclick="delete_integrate('<?php echo $value->commissions_id;?>');"><i class="fa fa-trash"></i></button>
                                                               </div>
                                                            </div>
                                                            </td>    
                                                         </tr>
      ...
      <script src="<?php echo base_url('js/backoffice/admin/integration.js'); ?>"></script> 
      <!-- [ Header ] end -->
      <!-- [ Main Content ] end -->
