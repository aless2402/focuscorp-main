            ...
            <div class="col-lg-12">
                <div class="breatcome-content text-center">
                    <div class="breatcome-title">
                        <h1>Actualizar PIN</h1>
                    </div>
                    <div class="breatcome-text">
                        <a href="<?php echo site_url();?>"><span>Inicio</span> PIN de Seguridad</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="row">
                    <div class="contact-form-box wow fadeInLeft" data-wow-delay=".4s">
                         ...
                         <form name="form-login" action="javascript:void(0);" onsubmit="recover_pin();" class="wpcf7-form init" method="post" enctype="multipart/form-data">
                              <input type="hidden" name="customer_id" id="customer_id" value="<?php echo $obj_customer[0]->customer_id;?>" />
                              <div class="row">
                                <div class="col-lg-6  col-md-6 col-sm-12">
                                    <div class="from-box">
                                       <input type="password" name="pin" id="pin"  size="40" minlength="6" maxlength="6" class="wpcf7-form-control wpcf7-text" placeholder="Ingrese nuevo pin" required=""/>
                                    </div>
                                </div>
                                <div class="col-lg-6  col-md-6 col-sm-12">
                                    <div class="from-box">
                                       <input type="password" name="new_pin" id="new_pin" minlength="6" maxlength="6"  size="40" class="wpcf7-form-control wpcf7-text" placeholder="Confirme nuevo pin" required=""/>
                                    </div>
                                </div>
                              </div>
...
<!--==================================================-->
    ...
    <script src='<?php echo site_url().'assets/js/script/new_forget.js?123';?>'></script>
