            ...
            <div class="col-lg-12">
                <div class="breatcome-content text-center">
                    <div class="breatcome-title">
                        <h1><?php echo lang('Global.recuperar_contrasena');?></h1>
                    </div>
                    <div class="breatcome-text">
                        <a href="<?php echo site_url();?>"><span><?php echo lang('Global.inicio');?></span> <?php echo lang('Global.recuperar_contrasena');?></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="contact-form-box wow fadeInLeft" data-wow-delay=".4s">
                         <div class="contact-form-title">
                            <h3><?php echo lang('Global.recupere_contrasena');?></h3>
                         </div> 
                         <form name="form-login" action="javascript:void(0);" onsubmit="recuperar();" class="wpcf7-form init" method="post" enctype="multipart/form-data">
                            <div class="row">
                            ...
                            <a class="white" href="<?php echo site_url()."iniciar-sesion";?>"><?php echo lang('Global.login');?></a>
                            <div class="from-box">
                                <button type="submit" id="submit"><i class="fa fa-share-square-o" aria-hidden="true"></i> <?php echo lang('Global.recuperar');?></button>
                            </div>
                        </form>
                    </div>
                </div>
